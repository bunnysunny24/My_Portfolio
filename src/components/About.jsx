        ...
        <div className="flex flex-col md:flex-row gap-16">
          ...
          <div className="md:w-7/12 animate-fade-in opacity-0">
            <h3 className="text-3xl font-bold text-primary mb-6">
              I'm <span className="text-accent italic">Albert Johnson</span>, a Frontend Developer
            </h3>
            ...
            <p className="text-lg mb-6 leading-relaxed text-gray-700">
              ...
              experience in the field, I am always looking forward to improving my skills.
            </p>
            
            <p className="text-lg mb-8 leading-relaxed text-gray-700">
              I believe that design is about solving problems and creating intuitive, 
              enjoyable experiences for users. Whether I'm working on a website, mobile app, 
              or other digital product, I bring my commitment to design excellence and 

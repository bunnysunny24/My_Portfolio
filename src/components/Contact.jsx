    ...
    <section id="contact" className="py-16 md:py-24 lg:py-32 relative overflow-hidden px-4 sm:px-6 md:px-0">
      ...
      <div className="container mx-auto z-10 relative">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-base md:text-lg max-w-xl md:max-w-2xl mx-auto mt-6 md:mt-8 text-gray-600 px-4 sm:px-6 md:px-0">
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="w-full lg:w-2/5 animate-fade-in opacity-0" style={{animationDelay: '0.2s'}}>
            <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 shadow-card h-full relative overflow-hidden group">
              {/* Decorative pattern */}
              ...
              <div className="relative">
                <h3 className="text-xl sm:text-2xl font-bold text-primary mb-5 md:mb-6 flex items-center">
                  ...
                  <div className="flex items-start transform hover:translate-x-2 transition-transform duration-300">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-gray-600 hover:text-primary transition-colors duration-300 text-sm sm:text-base break-all"
                      >
                ...
                <div className="mt-8 md:mt-12 pt-4 md:pt-6 border-t border-gray-100">
                  <h4 className="font-bold text-gray-900 mb-4 md:mb-6 text-sm sm:text-base">Connect With Me</h4>
          ...
          <div className="w-full lg:w-3/5 animate-fade-in opacity-0" style={{animationDelay: '0.4s'}}>
            <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 shadow-card relative z-10">
              <h3 className="text-xl sm:text-2xl font-bold text-primary mb-5 md:mb-6 flex items-center">
                <span className="w-6 md:w-8 h-0.5 bg-accent mr-2 md:mr-3"></span>
                Send Me a Message
              </h3>
